            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0" href="{{ url('admin/helps/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.help.actions.create') }}</a>
                    </div>
                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'problem'">{{ trans('admin.help.columns.problem') }}</th>
                                        <th is='sortable' :column="'problem'">{{ trans('admin.help.columns.estado') }}</th>
