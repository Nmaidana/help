...
class FillPermissionsForDetailAssist extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDetailAssist constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.detail-assist',
            'admin.detail-assist.index',
            'admin.detail-assist.create',
            'admin.detail-assist.show',
            'admin.detail-assist.edit',
            'admin.detail-assist.delete',
            'admin.detail-assist.bulk-delete',
        ]);
