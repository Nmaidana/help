...
class FillPermissionsForDetailHelp extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDetailHelp constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.detail-help',
            'admin.detail-help.index',
            'admin.detail-help.create',
            'admin.detail-help.show',
            'admin.detail-help.edit',
            'admin.detail-help.delete',
            'admin.detail-help.bulk-delete',
        ]);
